...
namespace HieuBon
{
    public class BotDemolitionWeapon : BotWeapon
    {
        ...
        private void Start()
        {
            par.transform.SetParent(LevelController.instance.pool);
        }
        ...
        public void Timer()
        {
            ...
            circle3.DOFillAmount(0f, time).SetEase(Ease.Linear).OnComplete(delegate
            {
                ...
                UIInGame.instance.virtualCam.StartShakeCam(2.5f);
        ...
        private void Update()
        {
            circle2.transform.LookAt(new Vector3(circle2.transform.position.x, UIInGame.instance.virtualCam.cam.transform.position.y, UIInGame.instance.virtualCam.cam.transform.position.z));
        }
