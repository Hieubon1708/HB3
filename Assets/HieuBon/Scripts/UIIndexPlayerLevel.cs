...
namespace Hunter
{
    public class UIIndexPlayerLevel : MonoBehaviour
    {
        UIIndexBarPlayerLevel[] indexBarPlayerLevels;
        ...
        public void Awake()
        {
            indexBarPlayerLevels = GetComponentsInChildren<UIIndexBarPlayerLevel>();         
        }
